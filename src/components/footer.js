                    ...
                    <div className='col-12 col-sm-6 col-md-4 footerMedia'>
                        <div className='socialMedia'>
                            <div className='row'>
                                ...
                                <div className='col-3 col-sm-3 col-md-3 col-xl-3 col-lg-3'>
                                    <a href='https://www.instagram.com/itsonlyfivepm/' target="_blank"><img src="/assets/img/footer/ig.svg" alt="instagram"/></a>
                                </div>
                                <div className='col-3 col-sm-3 col-md-3 col-xl-3 col-lg-3'>
                                    <a href='https://www.tiktok.com/@itsonly5pm' target="_blank"><img src="/assets/img/footer/tiktok.svg" alt="tiktok"/></a>
                                </div>
                                <div className='col-3 col-sm-3 col-md-3 col-xl-3 col-lg-3'>
                                    <a href='https://www.facebook.com/itsonly5pm' target="_blank"><img src="/assets/img/footer/fb.svg" alt="facebook"/></a>
                                </div>
                            </div>
                        </div>
