    ...
    return (
        <>
            <section className="mainServices container-fluid">
                <div className="row">
                    <div className="col-12 col-sm-12 mainServicesText">
            ...
            <section className='aproachServices container-fluid'>
                <div className='row rowAproach'>
                    ...
                    <div className='col-12 col-sm-4'>
                        <img className='imgBackgroundAproach' src="/assets/img/services/Rectangle5973.webp" alt="yellow background"/>
            ...
            <section className='processServices container-fluid'>
                <div className='row'>
                    <div className='col-12 col-sm-12 firstColProcess'>
                        <h2> OUR PROCESS </h2>
                    ...
                    <div className='col-12 col-sm-5 secondColProcess'>
                        <h3> 1. Discovery </h3>
                        <p> We work with you to understand your goals, ask better questions, identify your audience, and build context. </p>
                        <h3> 3. DESIGN </h3>
                        <p className='anotherPProcess'> We leverage design to tell your story better. We’ll get people staring — and thinking. Clean, beautiful designs that help your narrative flow. </p>
                        <h3> 5. DELIVERY </h3>
                        <p> Finally, we will carefully collect and prepare all project files to ensure smooth and easy use in the future. </p>
                    </div>
                    <div className='col-12 col-sm-5 thirdColProcess'>
